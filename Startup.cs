...
namespace MyWallWebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IPostService, PostService>();    //Configuração das classes injetadas
                                                                //Se Injeta é porque vai chamar uma função;
            ...
            services.AddScoped<DislikeRepository>();
